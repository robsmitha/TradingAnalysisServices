...
namespace Stocks.Domain.Models
{
    public class CandleStick
    {
        ...
        public CandleStick(StockPrice stockPrice)
        {
    ...
    public static class CandleStickExtensions
    {
        ...
        /// </summary>
        public static bool IsHammer(this LinkedListNode<CandleStick> node)
        {
            ...
            {
                if (Math.Abs(node.Value.ChangePercent) < Math.Abs(node.Previous.Value.ChangePercent))
                {
        ...
        /// </summary>
        /// <returns></returns>
        public static bool IsInvertedHammer(this LinkedListNode<CandleStick> node)
        {
            if (node == null || node.Previous == null) return false;
            var candleType = node.GetCandleStickType();
            if (candleType == CandleStickTypes.GreenHollow)
        ...
        /// <returns></returns>
        public static bool IsMorningStar(this LinkedListNode<CandleStick> node)
        {
        ...
        /// <param name="before"></param>
        /// <returns></returns>
        public static bool IsPiercingLine(this LinkedListNode<CandleStick> node)
        {
            if (node == null || node.Previous == null) return false;
            var candleType = node.GetCandleStickType();
            if (candleType == CandleStickTypes.GreenHollow)
        ...
        /// <param name="before"></param>
        /// <returns></returns>
        public static bool IsBullishEngulfing(this LinkedListNode<CandleStick> node)
        {
            if (node == null || node.Previous == null) return false;
        ...
        /// <returns></returns>
        public static decimal SubsequentVolume(this LinkedListNode<CandleStick> head)
        {
        ...
        public static CandleStickTypes GetCandleStickType(this LinkedListNode<CandleStick> node)
        {
